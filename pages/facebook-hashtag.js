...
const FacebookHashtagGenerator = () => {
  ...
  const getData = async () => {
    ...
    let userPrompt = `Write 15 Facebook hashtags based on "${hasHashtag}" ${hashtagDescription} in ${
  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Facebook Hashtag Generator [100% FREE - No Login required] — Scrip AI"
          description="Try the AI Facebook Hashtag Generator today and watch your posts go viral! Facebook Hashtag Generator by Scrip AI."
...
export default FacebookHashtagGenerator;
