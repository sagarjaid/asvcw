  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Instagram Reel Script Writer [100% FREE - No Login required] — Scrip AI"
          description="Write 30 sec Instagram Reel script powerd by AI and watch your IG Reel go viral! Try short video scripr by Scrip AI."
          slug="ig-reel-script"
        />
