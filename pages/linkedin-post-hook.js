...
const LinkedinPostHook = () => {
  ...
  const getData = async () => {
    let userPrompt = `Assume you are a Linkedin content creator. Write 1 sentence hook so that people will want to stop and watch the content creator ${prompt.language || 'English'
  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Linkedin Post Hook Writer [100% FREE - No Login required] — Scrip AI"
          description="Write Linkedin post hook headline that make your Linkeidn conncetions stop scrolling. Try Linkedin Hook generator by Scrip AI and watch your Linkedin post go viral!."
          slug="linkedin-hook"
        />
            ...
            <div className="flex w-full flex-col justify-between sm:flex-row">
              <div className="flex w-full flex-col gap-4 p-4 sm:w-2/5 ">
                ...
                <div className="flex flex-col gap-1 ">
                  ...
                  <textarea
                    type="text"
                    placeholder="Please enter post description if you want"
                    className="w-full rounded-md border p-1 text-xs placeholder:text-[9px] placeholder:text-gray-600"
                    rows="5"
                    maxLength={250}
...
export default LinkedinPostHook;