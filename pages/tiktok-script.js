  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI TikTok Script Writer [100% FREE - No Login required] — Scrip AI"
          description="Write 30 sec TikTok script powerd by AI and watch your TikTok's go viral! Try short video scripr by Scrip AI."
          slug="tiktok-script"
        />
