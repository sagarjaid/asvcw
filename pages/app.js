          ...
          <div className="flex flex-col sm:flex-row justify-between w-full">
            ...
            <div className="w-full flex flex-col gap-2 h-screen bg-stone-50 p-4">
              ...
              <div
                ...
                className="w-full border bg-white rounded-md p-2 h-[80vh] focus:outline-none placeholder:text-[8px] placeholder:text-gray-600"
              >
                <WindupChildren>
                  {data?.length
                    ? data?.map((el, index) => (
              ...
              <div className="flex justify-center sm:justify-end gap-4">
                <button
                  className='class="px-2 py-1 cursor-pointer mb-1 border rounded-md bg-rose-500 text-white p-2'
