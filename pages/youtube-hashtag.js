...
const YoutubeTagGenerator = () => {
  ...
  const getData = async () => {
    ...
    let userPrompt = `Write 4 Youtube hashtags based on "${hasHashtag}" ${hashtagDescription} in ${
  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Youtube Hashtag Generator [100% FREE - No Login required] — Scrip AI"
          description="Try the AI Youtube Hashtag Generator today and watch your posts go viral! YT Hashtag Generator by Scrip AI."
