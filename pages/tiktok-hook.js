...
const TiktokHook = () => {
  ...
  const getData = async () => {
    let userPrompt = `Assume you are a Tiktok content creator. Write 1 sentence hook so that people will want to stop and watch the content creator ${prompt.language || 'English'
  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Tiktok video Hook Writer [100% FREE - No Login required] — Scrip AI"
          description="Write Tiktok video hook headline that make your Linkeidn conncetions stop scrolling. Try Tiktok Hook generator by Scrip AI and watch your Tiktok video go viral!."
          slug="tiktok-hook"
        />
