...
const InstagramHashtagGenerator = () => {
  ...
  const getData = async () => {
    ...
    let userPrompt = `Write 28 Instagram hashtags based on "${hasHashtag}" ${hashtagDescription} in ${
  ...
  return (
    <>
      <div className="relative">
        <SEOMeta
          title="AI Instagram Hashtag Generator [100% FREE - No Login required] — Scrip AI"
          description="Try the AI Instagram Hashtag Generator today and watch your posts go viral! IG Hashtag Generator by Scrip AI."
